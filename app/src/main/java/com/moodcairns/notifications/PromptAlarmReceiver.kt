...
import com.moodcairns.MainActivity
...
class PromptAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_FIRE = "com.moodcairns.action.FIRE_PROMPT"

        const val EXTRA_SLOT = "com.moodcairns.extra.SLOT"
        const val EXTRA_WINDOW_ID = "com.moodcairns.extra.WINDOW_ID"
        const val EXTRA_LABEL = "com.moodcairns.extra.LABEL"
        const val EXTRA_FROM_NOTIFICATION = "com.moodcairns.extra.FROM_NOTIFICATION"
    }
}
